...
import { getSlotChildrenText } from '@/shared/utils/slots';
import type { DeepPartial } from '#ui/types';
import type { HeaderLink } from '@/types/ui';
import { useUIState } from '@/shared/composables/useUIState';
import KAsideLinks from '@/shared/components/aside/KAsideLinks.vue';
import KHeaderLinks from '@/shared/components/header/KHeaderLinks.vue';
